    ...
    <body>
		...
		<div class="wrapper">	
								...
								<div class="box box-warning">
									<div  class="box-header with-border">
										<div class="col-lg-12 col-md-12" style="text-align:center;margin-bottom:10px;margin-top:10px;" id="headerCatalogo">
                							<label class="apartamentosearchitittle"><img class="usersearchicon" src=""> Reporte De Pagos Comisiones</label>				
									...
									<div class="box-body" id="listCatalogo">
										<div class="row">
											<div class="col-md-12" id="busquedaApartamentos">
												<form autocomplete="off"  id="frmBuscar" name="frmBuscar" method="POST" action="./moduloReporteComisionesExcel.php">	
													<div class="row">	
														<div class="col-12 col-md-12" style="margin-bottom:10px;">
															...
															<input id="id_perfil" name="id_perfil" type="hidden" value="<?php echo $id_perfil ?>" >
																<div class="col-lg-2 col-md-2 col-xs-10" style="margin-bottom:10px;">
																	<label class="nodpitext">Vendedor:</label>
																	<select class="form-control" name="vendedorCom" id="vendedorCom" >
			...
			<script type="text/javascript">
				getVendedor('vendedorCom');
				function descargarEstadoCuenta(){
					//console.log("funcion buscar cliente");
					var formData = new FormData(document.getElementById("frmBuscar"));
					...
					$.ajax({
						url: "./cliente.php?get_comisiones_lista=true",
						type: "post",
						dataType: "json",
						data: formData,
						cache: false,
			...
			function niveles(torre,input,valueInput){
				...
				function torres(proyecto,input,valueInput){
					...
					$.ajax({
						url: "./cliente.php?get_torres_proyecto_com=true",
						type: "post",
						dataType: "json",
						data: formData,
						cache: false,
					...
					$.ajax({
						...
						success:function (response){
							...
							$.each(response.listado_usuarios,function(i,e) {
								output += ' <option value="'+e.id_usuario+'">'+e.nombreVendedor+'</option>';
							});
							//console.log(output);
							var option = document.getElementById(input);
							for (let i = option.options.length; i >= 0; i--) {
