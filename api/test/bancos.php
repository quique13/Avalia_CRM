								...
								<div class="box box-warning">
									<div  class="box-header with-border">
										<div class="col-lg-12 col-md-12" style="text-align:center;margin-bottom:10px;margin-top:10px;" id="headerCatalogo">
                							<label class="usersearchitittle"><img class="usersearchicon" src="../img/client_icon.png"> Bancos</label>
			...
			function agregarBanco(){
                ...
                function guardarBanco(){
					...
					if(error==0){
						...
						$.ajax({
							url: "./banco.php?agregar_editar_banco=true",
							type: "post",
							dataType: "json",
							data: formData,
							cache: false,
                ...
                function bancosList(){
                    ...
                    var formData = new FormData(document.getElementById("frmAgregarTorre"));
					$.ajax({
						url: "./banco.php?get_lista_bancos=true",
						type: "post",
						dataType: "json",
						data: formData,
						cache: false,
						...
						success:function (response){
							...
							$.each(response.listado_bancos,function(i,e) {
								...
								output += '<tr onCLick=""><td>'+count+'</td><td>'+e.estado+'</td><td>'+e.banco+'</td><td><button onclick="editarBanco('+e.idBanco+')" class="btn btn-xs" type="button"><img class="" src="../img/edit_button.png" alt="Editar Banco" ></button></td></tr>';
							});
							//console.log(output);
