								...
								<div class="box box-warning">
									<div  class="box-header with-border">
										<div class="col-lg-12 col-md-12" style="text-align:center;margin-bottom:10px;margin-top:10px;" id="headerCatalogo">
                							<label class="apartamentosearchitittle"><img class="usersearchicon" src=""> Reporte Apartamento Impuestos</label>				
									...
									<div class="box-body" id="listCatalogo">
										<div class="row">
											<div class="col-md-12" id="busquedaApartamentos">
												<form autocomplete="off"  id="frmBuscar" name="frmBuscar" method="POST" action="./moduloReporteClienteVentaImpuestosExcel.php">	
													<div class="row">	
