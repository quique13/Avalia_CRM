										...
										<form autocomplete="off"  enctype="multipart/form-data"  id="frmAgregarClienteCo" name="frmAgregarClienteCo" method="POST">
											<div class="row" >
												...
												<div class="col-lg-12 col-md-12 col-xs-10" style="margin-bottom:10px;text-align:center;">
													<button onclick="guardarCodeudor()" class="guardar" type="button">Guardar</button>
												</div>
											</div>
										</form>
									</div>
									...
									<div class="secinfo" >
										<form autocomplete="off"  enctype="multipart/form-data"  id="frmAgregarCliente" name="frmAgregarCliente" method="POST">
											<div class="row" >
												<!-- <div class="col-lg-4 col-md-4 col-xs-10" style="margin-bottom:10px;">
													<label class="nodpitext">Proyecto:</label>
													<select class="form-control" name="ProyectoCl" id="ProyectoCl"  onchange="niveles(this.value,'nivelCl')">
														<option value="" >Seleccione</optinon>
														<option value="Marabi" >Marabi</optinon>
														<option value="naos" >Naos</optinon>
													</select>
												</div>
												<div class="col-lg-4 col-md-4 col-xs-10" style="margin-bottom:10px;">
													<label class="nodpitext">Nivel:</label>
													<select class="form-control" name="nivelCl" id="nivelCl"  onchange="apartamentos(ProyectoCl.value,this.value,'apartamentoCl')">
													</select>
												</div>
												<div class="col-lg-4 col-md-4 col-xs-10" style="margin-bottom:10px;">
													<label class="nodpitext">Apartamento:</label>
													<select class="form-control" name="apartamentoCl" id="apartamentoCl" onchange="">
													</select>
												</div> -->
												...
												<div class="col-lg-6 col-md-6 col-xs-10" style="margin-bottom:10px;">
													...
													<div class="row" >
														...
														<div class="col-lg-12 col-md-12 col-xs-10" style="margin-bottom:10px;padding-right:0px">
															<label id="lblDireccion" name="lblDireccion" class="nodpitext">Dirección:</label>
												...
												<div class="col-lg-12 col-md-12 col-xs-10" style="margin-bottom:10px;">
													<form autocomplete="off"  enctype="multipart/form-data"  id="frmAgregarCliente" name="frmAgregarCliente" method="POST">
														<div class="row" >
															...
															<div class="col-lg-4 col-md-4 col-xs-10" style="margin-bottom:10px;" >
																<label class="nodpitext">Fecha Pago Inicial:</label>
															...
															<div class="col-lg-12 col-md-12 col-xs-10" style="margin-bottom:10px;text-align:center;">
																<br><br><button onclick="guardarEnganche()" class="guardar" type="button">Guardar</button>
															</div>
															<script type="text/javascript">
												...
												<div class="col-lg-12 col-md-12 col-xs-10" style="margin-bottom:10px;">
													<form autocomplete="off"  enctype="multipart/form-data"  id="frmAgregarCliente" name="frmAgregarCliente" method="POST">
														<div class="row" >
															...
															<div class="col-lg-2 col-md-2 col-xs-10" style="margin-bottom:10px;" >
																<label class="nodpitext">Télefono Contaco:</label>
